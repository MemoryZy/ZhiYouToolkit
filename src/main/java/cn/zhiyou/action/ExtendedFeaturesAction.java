    ...
    public static class HandlePopupGroupAction extends DefaultActionGroup {
        ...
        public void actionPerformed(@NotNull AnActionEvent e) {
            ...
            ListPopup popup = JBPopupFactory.getInstance()
                    .createActionGroupPopup("其他功能", this, e.getDataContext(),
        ...
        public AnAction @NotNull [] getChildren(@Nullable AnActionEvent e) {
            return new AnAction[]{
                    new GenerateMyBatisWhereTagAction(),
                    new GenerateMyBatisResultMapTagAction(),
                    new TextComparisonAction(),
                    new ConvertJsonAndXmlAction(),
                    new JasyptEncryptAndDecryptAction(),
                    new GenerateCurrentDateAction(),
                    new ConvertTimestampAndDateAction()
            };
        }
    }
