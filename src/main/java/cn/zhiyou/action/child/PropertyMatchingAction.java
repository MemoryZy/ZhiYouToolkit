 ...
 * @since 2024/3/15
 */
public class PropertyMatchingAction extends AnAction {
    public PropertyMatchingAction() {
        super("Property Matching (统计属性匹配)");
    }
    ...
    public void update(@NotNull AnActionEvent event) {
        // 设置可见性
        event.getPresentation().setEnabled(CreateSetterGetterMappingAction.hasProperty(event));
    }
