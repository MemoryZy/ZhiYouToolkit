...
public class Icons {
    ...
    public static final Icon zhiyou_small = IconLoader.getIcon("/icons/zhiyou.svg", Icons.class.getClassLoader());
    public static final Icon zhiyou_big = IconLoader.getIcon("/icons/zhiyou_big.svg", Icons.class.getClassLoader());

    public static final Icon error = IconLoader.getIcon("/icons/errorNew.svg", Icons.class.getClassLoader());
