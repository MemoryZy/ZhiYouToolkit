...
public class CreateMyBatisMapperDialogWrapper extends DialogWrapper {

    private static final Logger LOG = Logger.getInstance(CreateMyBatisMapperDialogWrapper.class);
    ...
    public CreateMyBatisMapperDialogWrapper(@NotNull AnActionEvent event, @Nullable Project project, Module module,
    ...
    public CreateMyBatisMapperDialogWrapper(AnActionEvent event, @Nullable Project project, JBIterable<? extends DasTable> dasTables, DasDataSource dasDataSource) {
        super(project, true);
        this.project = project;
        this.module = null;
    ...
    private String spliceResultMap(List<ColumnEntity> columnEntities, List<ColumnEntity> primaryKeyEntities) {
        ...
        for (int i = 0; i < allList.size(); i++) {
            ...
            String propertyName = CreateResultMapDialogWrapper.handlePropertyMapping(columnEntity.getPropertyName());
