...
public class CreateMyBatisMapperOnDataBaseDialogWrapper extends DialogWrapper {
    ...
    private static final Logger LOG = Logger.getInstance(CreateMyBatisMapperOnDataBaseDialogWrapper.class);
    private final CreateMyBatisMapperDialogWrapper wrapper;
    ...
    public CreateMyBatisMapperOnDataBaseDialogWrapper(@NotNull AnActionEvent event, @Nullable Project project, List<DbTable> dbTables) {
        super(project, true);
        ...
        this.wrapper = new CreateMyBatisMapperDialogWrapper(event, project, dasTables, dataSource);
