 ...
 * @since 2024/3/7
 */
public class JsonCollectTreeWindow extends DialogWrapper {

    private Tree tree;
    private JPanel rootPanel;
    private final JSON json;

    public JsonCollectTreeWindow(@Nullable Project project, JSON json) {
        super(project, true);
        this.json = json;
    ...
    private void initCellRenderer() {
        tree.setCellRenderer(new ColoredTreeCellRenderer() {
            ...
            public void customizeCellRenderer(@NotNull JTree tree, Object value, boolean selected, boolean expanded, boolean leaf, int row, boolean hasFocus) {
                ...
                Icon icon = IconLoader.getIcon("/icons/json_key.svg", JsonCollectTreeWindow.class.getClassLoader());
